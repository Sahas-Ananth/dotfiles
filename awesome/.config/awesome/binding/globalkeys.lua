...
function _M.get()
  local globalkeys = gears.table.join(
    ...
    end, { description = "Volume: Mute", group = "system" }),

    -- Media Control
    awful.key({}, "XF86AudioPlay", function()
      awful.util.spawn("playerctl play-pause", false)
    end, { description = "Media: Pause/Play", group = "system" }),
    ...
    end, { description = "lockscreen", group = "system" }),

    -- Screenshot
    awful.key({}, "Print", function()
      awful.util.spawn("flameshot gui", false)
    end, { description = "Screenshot", group = "system" }),

    -- Search GH repos
    awful.key({ modkey, "Shift" }, "s", function()
      awful.util.spawn("search_repos", false)
    end, { description = "Search GH Repos", group = "Utility" })
  )
